...
// Network Topology
// Number of  each section's wifi or csma nodes can be increased up to 250
//                     |                                  |
//         Section 1   |                                  |      Section 2
// --------------------|----------------------------------|--------------------
...
//                                   LAN
//
//echo_server在Section 1的10.1.2.3 ; 端口号为6 ; 客户端安装于Section 2的所有wifi_STA上以及LAN中的设备n1上
using namespace ns3;
...
main (int argc, char *argv[])
{
  ...
  if (nWifi_1 > 250 || nWifi_2 > 250 || nCsma > 250)
    {
      std::cout << "Too many wifi or csma nodes, no more than 250 in each section." << std::endl;
      return 1;
    }
...
//创建wifista无线终端，AP接入点
  ...
  NodeContainer wifiApNode_1 = csmaNodes.Get (0);
...
//创建wifista无线终端，AP接入点
  ...
  NodeContainer wifiApNode_2 = csmaNodes.Get (nCsma - 1);
 ...
 //csma信道
  ...
  clientApps_1.Start (Seconds (3.0+i));
